...

{
    ...
    function ametex_import_pack_defineds() {
        /**
         * Defines
         *
         */

        define( 'IMPORT_REMOTE_SERVER', 'https://package.beplusthemes.com/ametex/' );
    ...
    function ametex_import_pack_import_steps() {
        ...
        return apply_filters( 'ametex/import_pack/import_steps', [
            [
                ...
                'description' => __( 'Avoid risks during the import process, you should create a backup before performing install package demo. click \'yes\' to backup now or skip.', 'ametex' ),
            ...
            //     'description' => __( 'This package include __count_plugin__ plugin(s) please install and activate they before import content. click \'Explained\' to view all plugins.', 'ametex' ),
            ...
            [
                ...
                'description' => __( 'This process may take several minutes or longer depending on the network speed. Thanks you!', 'ametex' ),
        ...
        <div class="item inner-step">
            ...
            <div class="entry">
                ...
                <div class="buttons-action">
                    ...
                    <a href="<?php echo esc_url(home_url()); ?>" class="button button-primary"><?php _e( 'Go Home', 'ametex' ); ?></a>
                </div>
            </div>
        </div>
        <?php
