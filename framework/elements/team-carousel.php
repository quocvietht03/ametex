...
class Elementor_btTeamCarousel_Widget extends Widget_Base {

	public function get_name() {
		return 'bt_team_carousel';
	}

	public function get_title() {
		return __( 'BE Team Carousel', 'ametex' );
	}
	...
	protected function register_post_style_control() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bt-post__position' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
				'default' => [
					'size' => 10,
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bt-post__socials li a i' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bt-post__socials li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bt-post__socials li a' => 'border-style: solid; border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);

		$this->add_control(
			'post_socials_border_radius',
			[
				'label' => __( 'Border Radius', 'ametex' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				...
				'selectors' => [
					'{{WRAPPER}} .bt-post__socials li a' => 'border-radius: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bt-post__socials li:not(:last-child)' => 'margin-right: {{SIZE}}{{UNIT}}',
				],
				'default' => [
					'size' => 5,
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bt-post__socials' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
				'default' => [
					'size' => 15,
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bt-post__socials li a' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bt-post__socials li a' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name' => 'post_socials_shadow',
				'selector' => '{{WRAPPER}} .bt-post__socials li a',
			]
		);

		$this->end_controls_tab();

		$this->start_controls_tab( 'post_socials_hover',
			[
				'label' => __( 'Hover', 'ametex' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bt-post__socials li a:hover' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bt-post__socials li a:hover' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name' => 'post_socials_shadow_hover',
				'selector' => '{{WRAPPER}} .bt-post__socials li a:hover',
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper',
			[
				'class' => [ 'elementor-element', 'elementor-widget', 'bt-team-carousel' ],
			]
		);
						...
						<div class="swiper-wrapper">
							...
							<?php while ( $wp_query->have_posts() ) { $wp_query->the_post(); ?>
								<div class="swiper-slide">
									<?php require get_template_directory() . '/framework/elements/team/'.$settings['skin'].'.php'; ?>
								</div>
							<?php } ?>
						</div>
